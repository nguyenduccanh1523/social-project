  ...
  async up(queryInterface, Sequelize) {
    try {
      ...
      if (existingMedias && existingMedias[0] && existingMedias[0].count > 0) {
        console.log(`Medias table already has ${existingMedias[0].count} records. Skipping seeding.`);
        return;
      }
      ...
      const sampleMedias = [
        {
          documentId: uuidv4(),
          file_path: 'https://cdn2.fptshop.com.vn/unsafe/Uploads/Images/products/tablet.jpg',
        ...
        {
          documentId: uuidv4(),
          file_path: 'https://img.freepik.com/free-photo/abstract-grunge-decorative.jpg',
          file_type: 'image/jpeg',
          file_size: 2048,
          type_id: null,
          created_at: new Date(),
