...
export const getFriendsWithCount = async (req, res) => {
    try {
        // Lấy tham số phân trang từ query
        const pagination = req.query.pagination || {};
        const page = parseInt(pagination.page) || parseInt(req.query.page) || 1;
        ...
        // Gọi service để lấy danh sách bạn bè và đếm số lượng
        const friendsData = await friendService.getFriendsWithCount({
            page,
            pageSize,
            filters,
            sortField,
