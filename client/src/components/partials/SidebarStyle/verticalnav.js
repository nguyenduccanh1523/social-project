    ...
    <React.Fragment>
      <Accordion as="ul" className="navbar-nav iq-main-menu" id="sidebar-menu">
        ...
        <Nav.Item as="li">
          <Link
            className={`${
              location.pathname === "/dashboards/app/calendar" ? "active" : ""
            } nav-link `}
            aria-current="page"
        ...
        <Nav.Item as="li">
          <Link
            className={`${
              location.pathname === "/dashboards/app/birthday" ? "active" : ""
            } nav-link `}
            aria-current="page"
          ...
          >
            <OverlayTrigger
              placement="right"
              overlay={<Tooltip>Birthday</Tooltip>}
            >
        ...
        <Nav.Item as="li">
          <Link
            className={`${
              location.pathname === "/dashboards/app/weather" ? "active" : ""
            } nav-link `}
            aria-current="page"
          ...
          >
            <OverlayTrigger
              placement="right"
              overlay={<Tooltip>Weather</Tooltip>}
            >
        ...
        <Accordion.Item as="li" eventKey="market-menu" bsPrefix="nav-item">
          ...
          >
            <OverlayTrigger
              placement="right"
              overlay={<Tooltip>Market Place</Tooltip>}
            >
            ...
            <ul className="sub-nav">
              <Nav.Item as="li">
                ...
                >
                  ...
                  <OverlayTrigger
                    placement="right"
                    overlay={<Tooltip>Market1</Tooltip>}
                  >
              ...
              <Nav.Item as="li">
                ...
                >
                  ...
                  <OverlayTrigger
                    placement="right"
                    overlay={<Tooltip>Market2</Tooltip>}
                  >
            ...
            <ul className="sub-nav">
              <Nav.Item as="li">
                ...
                >
                  ...
                  <OverlayTrigger
                    placement="right"
                    overlay={<Tooltip>Blog Grid</Tooltip>}
                  >
              ...
              <Nav.Item as="li">
                ...
                >
                  ...
                  <OverlayTrigger
                    placement="right"
                    overlay={<Tooltip>Blog List</Tooltip>}
                  >
              ...
              <Nav.Item as="li">
                ...
                >
                  ...
                  <OverlayTrigger
                    placement="right"
                    overlay={<Tooltip>Blog Detail</Tooltip>}
                  >
                    <i className="sidenav-mini-icon"> BD </i>
                  </OverlayTrigger>
            ...
            <ul className="sub-nav">
              ...
              <Nav.Item as="li">
                ...
                >
                  ...
                  <OverlayTrigger
                    placement="right"
                    overlay={<Tooltip>Checkout</Tooltip>}
                  >
          ...
          <Accordion.Collapse eventKey="sidebar-special">
            <ul className="sub-nav">
              <Nav.Item as="li">
                <Link
                  className={`${
                    location.pathname === "/dashboard/extrapages/pages-timeline"
                      ? "active"
                      : ""
                  } nav-link`}
              ...
              <Nav.Item as="li">
                ...
                >
                  ...
                  <OverlayTrigger
                    placement="right"
                    overlay={<Tooltip>Pricing1</Tooltip>}
                  >
        ...
        <Nav.Item as="li">
          <Link
            className={`${
              location.pathname === "/dashboard/app/admin" ? "active" : ""
            } nav-link`}
            ...
            <ul className="sub-nav">
              <Nav.Item as="li">
                ...
                >
                  ...
                  <OverlayTrigger
                    placement="right"
                    overlay={<Tooltip>Basic Tables</Tooltip>}
                  >
              ...
              <Nav.Item as="li">
                ...
                >
                  ...
                  <OverlayTrigger
                    placement="right"
                    overlay={<Tooltip>Editable Table</Tooltip>}
                  >
