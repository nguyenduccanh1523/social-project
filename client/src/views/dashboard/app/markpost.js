...
import MarkBlog from '../component/MarkPost/markblog'
import profilebg7 from '../../../assets/images/page-img/profile-bg7.jpg'
import ProfileHeader from '../../../components/profile-header'
import SeeAll from '../icons/uiverse/SeeAll'
...
const MarkPost = () => {
    ...
    const handleSeeAllPost = () => {
        navigate('/mark-post/post');
    }

    const handleSeeAllBlog = () => {
        navigate('/mark-post/blog');
    }

    return (
        <>
            <ProfileHeader title="Mark Post" img={profilebg7} />
                        ...
                        <Col lg="12">
                            <Card className=" shadow-none p-0">
                                <Card.Header className=" d-flex justify-content-between rounded border-bottom-0">
                                    ...
                                    <div onClick={() => handleSeeAllPost()}>  <SeeAll /></div>
                                </Card.Header>
                            </Card>
                            <Row>
                                                ...
                                                <div className="d-flex align-items-center justify-content-between pb-3">
                                                    <div className="d-flex align-items-center">
                                                        ...
                                                        <div className="ms-2">
                                                            ...
                                                            {/* <h6><Link to="#">{convertToVietnamDate(postDetails[index]?.data?.createdAt)}</Link></h6> */}
                                                        </div>
                                                    </div>
                            ...
                            <Card className=" shadow-none p-0">
                                <Card.Header className=" d-flex justify-content-between rounded border-bottom-0">
                                    ...
                                    <div onClick={() => handleSeeAllBlog()}>  <SeeAll /></div>
                                </Card.Header>
                            </Card>
                            <Row>
                            <MarkBlog />
