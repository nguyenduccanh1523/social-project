...
import {
    apiDeleteDocumentComment,
    apiGetDocumentComment,
    apiGetDocumentCommentParent,
} from "../../../../../services/cmtDocument";
import {
    Space,
    Divider,
    Typography,
...
const ActionComment = ({ blog }) => {
    ...
    return (
        <>
            ...
            <ul className="blog-comments list-inline p-0 m-0">
                            ...
                            <div className="d-flex">
                                ...
                                <div className="comment-data-block ms-3">
                                    ...
                                    {showNestedComments[comment.documentId] && comment.documentId === currentParentId && (
                                        <ul className="blog-comments list-inline p-0 m-0 mt-2">
                                            {isLoading ? (
                                                <p>Loading replies...</p>
                                            ) : (
