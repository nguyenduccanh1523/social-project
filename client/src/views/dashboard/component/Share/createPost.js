            ...
            <div className="d-flex align-items-center">
              <div className="user-img">
                <img
                  loading="lazy"
                  src={
                    profile?.profile_picture || page?.profile_picture?.file_path
                  }
                  alt="userimg"
              ...
              <li className="col-md-6 mb-3">
                <div className="bg-soft-primary rounded p-2 pointer me-3">
                  <Upload
                    ...
                    onPreview={() => {}}
                  >
                    <Button className="absolute bottom-2 right-2 d-flex " style={{ width: "350px" }}>
                  ...
                  <div className="user-img me-3">
                    <img
                      ...
                      src={
                        ...
                        page?.profile_picture?.file_path
                      }
                      alt="userimg"
                      className="avatar-60 rounded-circle img-fluid"
                    />
                      ...
                      >
                        <div className="d-flex align-items-top">
                          ...
                          <div className="data ms-2">
                            <h6>Public</h6>
                            <p className="mb-0">Anyone on or off SocialV</p>
                          </div>
                        </div>
                      </Dropdown.Item>
                      <Dropdown.Item
