...
const Bookmark = ({ isChecked , onChange }) => {
    return (
      <StyledWrapper>
        <div className="bookmark-checkbox">
          <input 
            ...
            onChange={onChange} // Ensure onChange handler is provided
          />
          <label htmlFor="bookmark-toggle" className="bookmark-checkbox__label">
